  ...
  () => {
    ...
    it(
      ...
      async () => {
        ...
        /*
         * Anchor the simulated security clock after the
         * database-created session timestamp.
         *
         * AuthSession.createdAt is generated by MySQL.
         * Using a calendar-fixed date here eventually makes
         * occurredAt older than createdAt and correctly
         * violates:
         *
         * revokedAt >= createdAt
         */
