...
if (
  ...
  throw new Error(
    'Functions levels integration requires NODE_ENV=test and a DB_NAME ending in _test',
  );
}
...
describe(
  'Functions imported three-level catalog',
  () => {
    beforeAll(
      async () => {
    ...
    it(
      ...
      async () => {
        ...
        if (concept === null) {
          throw new Error(
            'Functions concept was not imported',
          );
        }
